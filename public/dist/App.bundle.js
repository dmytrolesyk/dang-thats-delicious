...
exports.default = async function (e) {
  ...
  e.preventDefault();
  var res = await _axios2.default.post(this.action);
...
var loadPlaces = async function loadPlaces(map) {
  ...
  var res = await _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng);
  var places = res.data;
  if (!places.length) {
    return;
  }
...
exports.default = function (search) {
  ...
  searchInput.on('input', async function () {
    ...
    var res = await _axios2.default.get('/api/search?q=' + this.value);
    if (res.data.length) {
